...
parser.add_argument('--commonsense-path', default='', type=str, metavar='N', help='path to commonsense information')
...
parser.add_argument('--cake-ratio', default=0.5, type=float, metavar='N',
                    help='how many negative samples are sampled by CAKE')
