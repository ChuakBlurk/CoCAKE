...
parser.add_argument('--commonsense-path', default='', type=str, metavar='N',
                    help='path to commonsense dir')
parser.add_argument('--head-ns-cnt', default=32, type=int, metavar='N',
                    help='head-ns-cnt')
parser.add_argument('--tail-ns-cnt', default=32, type=int, metavar='N',
                    help='tail-ns-cnt')
